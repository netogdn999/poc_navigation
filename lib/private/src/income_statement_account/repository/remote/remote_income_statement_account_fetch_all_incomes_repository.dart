...
class RemoteIncomeStatementAccountFetchAllIncomesRepositoryImpl implements IncomeStatementAccountFetchAllIncomesRepository {
  @override
  Future<Response<Failure, List<IncomeStatementAccountModel>>> call() async {
    try {
      final response = await get(path: "/incomeStatementAccount/income");
